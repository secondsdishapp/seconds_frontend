        ...
        <div className="about_container">
            ...
            <div className="team-list-container">
                ...
                <div className="team-container">
                    <div className="white-overlay">
                        <img src="https://example.com/jorge-team.jpg" alt="'s team picture" className="team-pic" />
                    </div>
                ...
                <div className="team-container">
                    <div className="white-overlay">
                        <img src="https://example.com/Ayyoub-team.jpg" 
                        alt="Ayyoub's team picture" 
                        className="team-pic" />
                    </div>
                    ...
                    <div className="team-container">
                    <div className="white-overlay">
                        <img src="https://example.com/jorge-team.jpg" alt="Jorge's team picture" className="team-pic" />
                    </div>
                ...
                <div className="team_container">
                    <div className="white_overlay">
                        <img 
                            src="https://example.com/niki-team.jpg" 
